...
# Here’s a clean, well-structured **Markdown (`README.md`)** version with improved formatting and readability, without changing the content.
...
For this dataset, the outcome (also known as the **ground truth**) is provided for each passenger.
...
The test set is used to evaluate how well your model performs on **unseen data**.
For this dataset, the ground truth is **not provided**.

Your task is to:

* Use the trained model
* Predict whether each passenger **survived** the sinking of the Titanic
