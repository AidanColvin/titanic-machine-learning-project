...
## Overview
Evaluates four machine learning algorithms.
## Models
* **Random Forest**
* **Logistic Regression**
* **Gradient Boosting**
...
"""
    ...
    print("\n>>> Setup Complete! Running Comparison now...")
    # Execute the comparison script automatically
    os.system("python scripts/compare_models.py")
